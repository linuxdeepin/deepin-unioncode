...
{
    auto records = CodeGeeXManager::instance()->sessionRecords();
...
void HistoryListWidget::initConnection()
{
    ...
    connect(CodeGeeXManager::instance(), &CodeGeeXManager::sessionRecordsUpdated, this, &HistoryListWidget::onSessionRecordUpdated);
}
