...
//from https://www.w3school.com.cn/cssref/css_colors.asp
namespace StyleColor
{
    ...
    static int color(const QColor &col)
    {
        return (col.blue() << 16) | (col.green() << 8) | col.red();
    }

    static int colorAlpha(const QColor &col)
    {
        return (col.alpha() << 24) | (col.blue() << 16) | (col.green() << 8) | col.red();
    }

    static int colorAlpha(const QColor &col, const char alpha) {
        return (col.alpha() << 24) | (col.blue() << 16) | (col.green() << 8) | col.red();
    }
};
