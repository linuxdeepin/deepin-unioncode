 ...
 */
#include "optioncmake.h"
#include "mainframe/optioncmakegenerator.h"
...
void OptionCmake::initialize()
{
    DPF_USE_NAMESPACE;
}

bool OptionCmake::start()
{
...
dpf::Plugin::ShutdownFlag OptionCmake::stop()
{
    return Sync;
}
