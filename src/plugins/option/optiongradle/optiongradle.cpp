 ...
 */
#include "optiongradle.h"
#include "mainframe/optiongradlegenerator.h"
...
void OptionGradle::initialize()
{
    DPF_USE_NAMESPACE
}

bool OptionGradle::start()
{
...
dpf::Plugin::ShutdownFlag OptionGradle::stop()
{
    return Sync;
}
