...
A machine-readable JSON schema can be found [here](/debug-adapter-protocol/debugAdapterProtocol.json).
...
Some predefined types for the CompletionItem. Please note that not all clients have specific icons for all of them. Values: ‘method’, ‘function’, ‘constructor’, ‘field’, ‘variable’, ‘class’, ‘interface’, ‘module’, ‘property’, ‘unit’, ‘value’, ‘enum’, ‘keyword’, ‘snippet’, ‘text’, ‘color’, ‘file’, ‘reference’, ‘customcolor’, etc.
...
userUnhandled: breaks if the exception is not handled by user code. Values: ‘never’, ‘always’, ‘unhandled’, ‘userUnhandled’, etc.
...
[Base Protocol](#Base_Protocol-side)
...
[Reverse Requests](#Reverse_Requests-side)
